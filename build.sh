...
# Add on the rest of the index file
echo -n '</script><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/></head><body onload="startup()"><div id="wrapper"><canvas id="canvas" width="1280" height="720"></canvas></div></body></html>' >> "${indexcat}"
